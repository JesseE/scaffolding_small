...
test('ignoreMissing option', function (t) {
    t.test('on browserify', function(t) {
        ...
        var ignored = browserify({
            entries: [__dirname + '/ignore_missing/index.js'],
            ignoreMissing: true
        });
    ...
    t.test('on .bundle', function(t) {
        ...
        var ignored = browserify(__dirname + '/ignore_missing/index.js', {
            ignoreMissing: true
        });
    ...
    t.test('defaults to false', function (t) {
        ...
        var expected = browserify(__dirname + '/ignore_missing/index.js');
